...
<div class="main">
    ...
    <table>
     ...
     // where unit_id='"+request.getParameter("unit_id")+"' and property_id='"+session.getAttribute("p_id")+"'
      ...
      String query="select * from expense where unit_id='"+session.getAttribute("unit_id")+"' ";

      System.out.println(session.getAttribute("unit_id"));
...
<div class="text-center">
			<a href="expense_deleter.jsp" class="btn btn-primary">reset</a>
