...
<input  class="btn btn-warning" value="back" type="submit" />
      ...
      <a href="File_Upload.jsp" class="btn btn-info"> Upload Document
 ...
 %>
                 ...
                 <h5><%= rset.getString("BookId") %></h5>
                 <form action="./FileReadPdf" >
                 <button type="sumbit">
                 <input id="idd" name="BookId" value="<%=rset.getString("BookId") %>" hidden>
                 <img src="notes/download.png" alt="Girl in a jacket" width="50%" height="120">
                 <center> </center>
                 </button></form>
                 <form action="doc_deleter.jsp">
                 <input name="doc_name" id="book_id" value="<%= rset.getString("doc_id") %>" hidden/>
