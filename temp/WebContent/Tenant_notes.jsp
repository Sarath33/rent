	...
	<div class=" mdl-layout mdl-js-layout mdl-layout--fixed-header">
		...
		<input name="p_id" value="<%= session.getAttribute("p_id") %>" hidden/>
			...
			<div id="holder" style="padding-left: 90px; ">
				<ul id="todo" style="margin-top: 10px;">
				<br><br><br>
				<% 
Connection con = null;
ResultSet rs = null;
...
<div class="box one"><div id="shade"><div class="header" id="header"><%=rs.getString("title")%> </div><div class="container"><div class="two"> <%=rs.getString("note")%> </div><div><center> </center></div> </div></div></div>
